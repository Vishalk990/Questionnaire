        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            <div key={field.name} className="">
              <label
                htmlFor={field.name}
                className="block text-sm font-normal text-[#003399]"
              >
                {field.label}
              </label>
              <input
                ...
                className="w-full px-3 mt-1 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              {errors[field.name] && (
